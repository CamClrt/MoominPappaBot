...
class TestParser:
    ...
    def test_check_question_mark(self):
        assert self.PARSER.check_question_mark("Où est Moomin World ?") == True

    def test_check_question_mark(self):
        assert self.PARSER.check_question_mark("Moomin World") == False
    ...
    def test_process_question(self):
        ...
        assert self.PARSER.process_question(sentence) == "moomin world"